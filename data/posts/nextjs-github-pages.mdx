...
Vercel promotes itself as _"The easiest way to deploy your Next.js app"_ and Netlify offers a similar service. However, both Vercel and Netlify really want you on _their platforms_.
...
> Update... Vercel has since published an [official example](https://github.com/vercel/next.js/tree/canary/examples/gh-pages). I recommend you research the official example before making any major decisions.

<SideNote type="warning">
<strong>Heads up!</strong> Github Pages doesn't support serverless functions. This means dynamic functionality (such as API Routes) will be disabled. <a href="https://nextjs.org/docs/advanced-features/static-html-export#caveats">Learn more</a>.
</SideNote>
