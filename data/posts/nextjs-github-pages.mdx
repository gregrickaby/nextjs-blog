...
⬇️ Just show me the code! ⬇️

- [View the Github Repo](https://github.com/gregrickaby/nextjs-github-pages)
- [View the deployed app](https://gregrickaby.github.io/nextjs-github-pages/)

## Introduction

[Vercel](https://vercel.com/) promotes itself as _"The easiest way to deploy your Next.js app"_ and [Netlify](https://www.netlify.com/) offers a similar service. However, both Vercel and Netlify really want you on _their platforms_.

I'm interested in owning my own data, and wanted to see if I could deploy a Next.js app to Github Pages. During my research, **I've found very little documentation around deploying a static Next.js app to Github Pages.** Well, I figured it out and I'm sharing what I learned with you.

<SideNote>
  <p className="text-black mb-0">
    <strong>
      Update: Vercel has since published{' '}
      <a
        className="text-black underline hover:no-underline"
        href="https://github.com/vercel/next.js/tree/canary/examples/gh-pages"
      >
        an official example.
      </a>
    </strong>{' '}
    I recommend you research the official example before making any major
    decisions.
  </p>
</SideNote>
...
- [Dynamic Routes with Next Export (and say - Vercel) vercel/next.js#28216](https://github.com/vercel/next.js/discussions/28216#discussioncomment-1203150)

## Getting Started

<SideNote>
  I'm going to gloss over this part, because I assume you already know how to
  <a href="https://help.github.com/en/github/getting-started-with-github/create-a-repo">
    create a Github repository
  </a> and <a href="https://nextjs.org/docs/getting-started#setup">
    generate a Next.js app
  </a>.
</SideNote>

You'll need to place a `.nojekyll` file in `/public` to bypass Github Pages from trying to [auto-generate a static Jekyll site](https://github.blog/2009-12-29-bypassing-jekyll-on-github-pages/).
