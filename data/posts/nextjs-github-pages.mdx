...
Vercel has since published [an official gh-pages example](https://github.com/vercel/next.js/tree/canary/examples/gh-pages). While the implementation I wrote about below still works, I recommend looking at their example before making any major decisions.
