...
When WordPress 3.5 beta 1 was released it came with, ["Twenty Twelve"](http://wordpress.org/extend/themes/twentytwelve). While looking at `style.css`, I noticed the use of "REM" to set font sizes and margins. I had NO idea what an REM was. In fact, I just started using EM's in other child-themes. Immediately, I turned to Google and started researching.
...
How would that look in our sample stylesheet?
...
Yes, you can even use REM to set your margins. Margins, or "vertical rhythm" is calculated using either 24px or 48px. Let's divide 24px by our `$rembase`
...
REM's are supported in all browsers all the way down to IE9. Check out the list: [http://caniuse.com/rem](http://caniuse.com/rem)

## Wrap up

The purpose of this post was not to stand on a soapbox and preach, but educate you on the advantages of using REM's to enhance the typography on your site.

### Bonus: PX to REM Sass Mixin
...
REM unit explanation on YouTube:

<iframe
  width="560"
  height="315"
  src="https://www.youtube-nocookie.com/embed/XbU-i1SE5JY"
