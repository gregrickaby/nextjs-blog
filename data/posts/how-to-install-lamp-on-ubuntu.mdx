...
When it's finished, open a web browser and type:
...
In my experience ZIP is great for creating archives for sharing via email or SFTP. It's a universal format that almost everyone can open. I would NOT use ZIP for file backups. For large backups, see 7ZIP or TAR below.
