...
![export](/optimized/export-from-wordpress.png)
...
![wordpress-export-to-markdown-wizard](/optimized/wordpress-export-to-markdown.png)
...
![image](/optimized/move-posts-to-gatsby.gif)
...
![github-repo-with-initial-commit](/optimized/github-repo-with-initial-commit.png)
