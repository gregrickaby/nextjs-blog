 ...
 *
 * @see https://www.npmjs.com/package/fs-readdir-recursive
 * @returns array
 */
export function getPostPaths() {
  // Use fs-readdir-recursive to do the heavy lifting.
  const readDirRecursive = require('fs-readdir-recursive')

  // Get all of the post directories.
  return readDirRecursive(systemPath)
}
