...
const systemDirectory = join(process.cwd(), postsDirectory)
...
export function getPostSlugs() {
  ...
  const postDirectories = getDirectories(systemDirectory)
  ...
  postDirectories.map((postDir) => {
    ...
    const fullPath = path.join(postsDirectory, postDir)
 ...
 * @returns {string}        The blog post HTML.
 */
 ...
 * @returns {string}   A browser friendly route.
 */
